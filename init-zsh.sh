...
echo "plugins=(autojump web-search extract docker zsh-autosuggestions zsh-syntax-highlighting zsh-history-substring-search)" >> ~/.zshrc
echo "export TERM=xterm-colors" >> ~/.zshrc
